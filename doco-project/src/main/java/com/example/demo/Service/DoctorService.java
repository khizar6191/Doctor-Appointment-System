...
public class DoctorService {
	...
	public long getDoctorCount()
	{
	 ...
	 public List <Doctors> getDoctByLId(int location_id_) 
		{
				Locations l=lr.findById(location_id_).get();
				
				return dr.getDoctorByLId(l);
		}
...
//			return ap.getAppointmentsofPatient(p);
//		}
