...
CREATE TABLE `patients` (
  ...
  CONSTRAINT `patients_ibfk_1` FOREIGN KEY (`user_id_`) REFERENCES `users` (`id_`)
...
INSERT INTO `patients` VALUES (1,2,'Alice','Smith','Female','alice@example.com','patient_password','456 Elm St','1990-05-15','98765432');
