    ...
    <div className="doc">
        ...
        <input type="hidden" name="role_id_" value="2"/>
            ...
            <div class="mb-3">
                ...
                <div className="error-msg" style={{color:"red"}}> {info.lname_.error}</div> 
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="email_" class="form-control" id="email_" placeholder="Enter email_..."  name="email_" value={info.email_.value}
                 ...
                 <div className="error-msg" style={{color:"red"}}> {info.email_.error}</div> 
            </div>
            ...
            <div class="mb-3">
                ...
                <div className="error-msg" style={{color:"red"}}> {info.contact_.error}</div> 
            </div>
            ...
            <div class="mb-3">
                ...
                <div className="error-msg" style={{color:"red"}}> {info.description_.error}</div> 
                ...
                <div className="error-msg" style={{color:"red"}}> {info.address_.error}</div> 
                
                </div>

                <div class="mb-3">
                <label for="location_id_" class="form-label">Area :</label>
                <select style={{width:200}}  onChange={(e)=>dispatch({type: 'update', data: {name:"location_id_",value:e.target.value,touched: true, valid:true, error:""} })}>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control" id="email_" placeholder="Enter experience_..."  name="experience_" value={info.experience_.value}
                 ...
                 <div className="error-msg" style={{color:"red"}}> {info.experience_.error}</div> 
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="password" class="form-control" id="password_" placeholder="Enter password_"  name="password_" value={info.password_.value}
                 ...
                 <div className="error-msg" style={{color:"red"}} > {info.password_.error}</div> 
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="password"  class="form-control" id="cpassword_" placeholder="Enter Confirm password_"   name="cpassword_" 
                        ...
                        <div className="error-msg" style={{color:"red"}}> {info.cpassword_.error}</div>  
            ...
            <div class="mb-3">
                ...
                onChange={(e)=>dispatch({type: 'update', data: {name:"answer_",value:e.target.value,touched: true, valid:true ,formvalid:true} })}/>
            </div>
